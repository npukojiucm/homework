import pytest
from Tests_Task1.main import add_new_doc, get_doc_shelf, get_doc_owner_name, show_all_docs_info, delete_doc
...
@pytest.mark.parametrize('doc_number, doc_type, doc_owner_name, doc_shelf_number', new_fixtures)
